...
#sample_c0_elmo1_bilinear = [0.955156168207991, 0.967245806017399, 0.971957025699828]
...
#sample_c1_elmo1_bilinear = [0.610115412418675, 0.695989231497868, 0.7165042251414612]
...
sample_result_dict = json.load(open('summarize_dep_sample/results.json'))
sample_x_axis = sample_result_dict["hyperparameter_options"]
sample_c1_elmo1_bilinear = sample_result_dict["sample"]["1"]["bilinear"]
sample_c1_elmo1_1hid = sample_result_dict["sample"]["1"]["1hid"]
sample_c1_elmo1_2hid = sample_result_dict["sample"]["1"]["2hid"]
sample_c0_elmo1_bilinear = sample_result_dict["sample"]["0"]["bilinear"]
...
sample_diff_elmo1_bilinear = [x-y for x, y in zip(sample_c0_elmo1_bilinear, sample_c1_elmo1_bilinear)]

# Rank
#rank_x_axis = [2, 4, 10, 45, 1000]
#rank_c0_elmo1_bilinear = [0.852381783283894, 0.952364334322107, 0.969564025226213, 0.97113443178702, 0.971957025699828]
...
#rank_c1_elmo1_bilinear = [0.403744048657676, 0.533040855497669, 0.646135054964229, 0.716379589700127, 0.7165042251414612]
...
#rank_c0_elmo1_bilinear = [0.8367774260288656, 0.9516414487623701, 0.9700127128150161, 0.9726300570830322, 0.9716329735523593]
#rank_c1_elmo1_bilinear = [0.41832639529376575, 0.5413415758905202, 0.6401276266919261, 0.7120173492534337, 0.7119924221651669]
...
rank_result_dict = json.load(open('summarize_dep_rank/results.json'))
rank_x_axis = rank_result_dict["hyperparameter_options"]
rank_c1_elmo1_bilinear = rank_result_dict["rank"]["1"]["bilinear"]
rank_c1_elmo1_1hid = rank_result_dict["rank"]["1"]["1hid"]
rank_c1_elmo1_2hid = rank_result_dict["rank"]["1"]["2hid"]
rank_c0_elmo1_bilinear = rank_result_dict["rank"]["0"]["bilinear"]
...
rank_diff_elmo1_bilinear = [x-y for x, y in zip(rank_c0_elmo1_bilinear, rank_c1_elmo1_bilinear)]

# Dropout
#dropout_x_axis = list(reversed([0, 0.2, 0.4, 0.6, 0.8]))
#dropout_c0_elmo1_bilinear = list(reversed([0.97195702569982, 0.972056734052895, 0.971608046464092, 0.96891592093127, 0.9626093675997707]))
...
#dropout_c1_elmo1_bilinear = list(reversed([0.716504225141461, 0.70369170177231, 0.680434728419373, 0.646683450906099, 0.5812498442056984]))
...
dropout_result_dict = json.load(open('summarize_dep_dropout/results.json'))
dropout_x_axis = dropout_result_dict["hyperparameter_options"]
dropout_c1_elmo1_bilinear = dropout_result_dict["dropout"]["1"]["bilinear"]
dropout_c1_elmo1_1hid = dropout_result_dict["dropout"]["1"]["1hid"]
dropout_c1_elmo1_2hid = dropout_result_dict["dropout"]["1"]["2hid"]
dropout_c0_elmo1_bilinear = dropout_result_dict["dropout"]["0"]["bilinear"]
...
dropout_diff_elmo1_bilinear = [x-y for x, y in zip(dropout_c0_elmo1_bilinear, dropout_c1_elmo1_bilinear)]

# Weight Decay
#weightdecay_x_axis = list(reversed([0, 0.01, 0.1, 1.0]))
#weightdecay_c0_elmo1_bilinear = list(reversed([0.97195702569982, 0.971458483934491, 0.962060971657900, 0.8603335244410101]))
...
#weightdecay_c1_elmo1_bilinear = list(reversed([0.716504225141461, 0.713114141137173, 0.666525413166488, 0.4413340977640402]))
...
wd_result_dict = json.load(open('summarize_dep_wd/results.json'))
weightdecay_x_axis = wd_result_dict["hyperparameter_options"]
weightdecay_c1_elmo1_bilinear = wd_result_dict["wd"]["1"]["bilinear"]
weightdecay_c1_elmo1_1hid = wd_result_dict["wd"]["1"]["1hid"]
weightdecay_c1_elmo1_2hid = wd_result_dict["wd"]["1"]["2hid"]
weightdecay_c0_elmo1_bilinear = wd_result_dict["wd"]["0"]["bilinear"]
...
weightdecay_diff_elmo1_bilinear = [x-y for x, y in zip(weightdecay_c0_elmo1_bilinear, weightdecay_c1_elmo1_bilinear)]

# Gradient Steps
#gradsteps_x_axis = [1500, 3000, 6000, 12500, 25000, 50000]
#gradsteps_c0_elmo1_bilinear = [0.970536181668619, 0.971832390258493, 0.972081661141162, 0.972281077847296, 0.970885160904354, 0.9711593588752898]
...
#gradsteps_c1_elmo1_bilinear = [0.697983398559214, 0.707405837924072, 0.713737318343844, 0.713488047461176, 0.715158162375052, 0.716254954258793]
...
gradient_steps_result_dict = json.load(open('summarize_dep_gradient_steps/results.json'))
gradsteps_x_axis = gradient_steps_result_dict["hyperparameter_options"]
gradsteps_c1_elmo1_bilinear = gradient_steps_result_dict["gradient_steps"]["1"]["bilinear"]
...
gradsteps_c0_elmo1_bilinear = gradient_steps_result_dict["gradient_steps"]["0"]["bilinear"]
...
gradsteps_diff_elmo1_bilinear = [x-y for x, y in zip(gradsteps_c0_elmo1_bilinear, gradsteps_c1_elmo1_bilinear)]

fig = plt.figure(figsize=(10,3.5))
#fig = plt.figure(figsize=(10,4.5))
#fig.suptitle('Regularization / Model Constraint Method')
fig.suptitle(r'\bf Unlabeled Dependency Accuracy and Selectivity Across Complexity Control Methods')
...
ax1.plot([str(x) for x in sample_x_axis], sample_c0_elmo1_bilinear, markersize=4, marker='s')
ax1.set_ylim((.75,.95))
...
ax2.plot([str(x) for x in sample_x_axis], sample_diff_elmo1_bilinear, markersize=4, marker='s')
...
#ax11.plot([str(x) for x in sample_x_axis], sample_diff_elmo1_bilinear, markersize=4, marker='s')
...
ax3.plot([str(x) for x in rank_x_axis], rank_c0_elmo1_bilinear, markersize=4, marker='s')
...
ax4.plot([str(x) for x in rank_x_axis], rank_diff_elmo1_bilinear, markersize=4, marker='s')
...
#ax12.plot([str(x) for x in rank_x_axis], rank_diff_elmo1_bilinear, markersize=4, marker='s')
...
ax5.plot([str(x) for x in dropout_x_axis], dropout_c0_elmo1_bilinear, markersize=4, marker='s')
...
ax6.plot([str(x) for x in dropout_x_axis], dropout_diff_elmo1_bilinear, markersize=4, marker='s')
...
#ax13.plot([str(x) for x in dropout_x_axis], dropout_diff_elmo1_bilinear, markersize=4, marker='s')
...
ax7.plot([str(x) for x in weightdecay_x_axis], weightdecay_c0_elmo1_bilinear, markersize=4, marker='s')
...
ax8.plot([str(x) for x in weightdecay_x_axis], weightdecay_diff_elmo1_bilinear, markersize=4, marker='s')
...
#ax14.plot([str(x) for x in weightdecay_x_axis], weightdecay_diff_elmo1_bilinear, markersize=4, marker='s')
...
ax9.plot([str(x) for x in gradsteps_x_axis], gradsteps_c0_elmo1_bilinear, markersize=4, marker='s', label='Linear')
...
ax10.plot([str(x) for x in gradsteps_x_axis], gradsteps_diff_elmo1_bilinear, markersize=4, marker='s')
...
#ax15.plot([str(x) for x in gradsteps_x_axis], gradsteps_diff_elmo1_bilinear, markersize=4, marker='s')
...
#ax1.bar(sample_x_axis, sample_c0_elmo1_bilinear, width=10000)
...
plt.savefig('depcontrol', dpi=400)
